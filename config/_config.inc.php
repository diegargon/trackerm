...
$cfg['ROOT_PATH'] = ''; // Where reside the files, Something like /var/www/trackerm
$cfg['REL_PATH'] = ''; // ex: '/' or '/trackm'
...
$cfg['MOVE_ONLY_INAPP'] = 0; //0 move only media download with trackerm, 1 will scan and move all media download in torrent path
$cfg['CREATE_MOVIE_FOLDERS'] = 0;
$cfg['CREATE_SHOWS_SEASON_FOLDER'] = 1;
$cfg['TORRENT_MEDIA_REGEX'] = '(\.avi|\.mp4|\.mkv)';
$cfg['FILES_USERGROUP'] = ''; //When moving change the usergroup Default, not change, torrent-daemon group.
