...
// Where transmission put finished download files (you must separated finish torrents directory  and the temporal file directory)
...
// What Jacket indexer will use, check link in Jacket Web interface (Actions) the NAME ex:  http://192.168.X.XX:9117/api/v2.0/indexers/NAME/results/
