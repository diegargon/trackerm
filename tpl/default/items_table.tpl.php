...
if (isset($tdata['tpl_var_ary_first'])) {
    ...
    <div class="divTable">
        ...
        <!-- REPEAT -->
        <?php
        if (isset($tdata['tpl_var_ary_item_break']) && $tdata['tpl_var_ary_item_break'] === 1 && !isset($tdata['tpl_var_ary_first'])) {
            ?>
        </div> <!-- close table row -->
        <div class="divTableRow">
        <?php } ?>
            ...
            <div class="display display_1">
                ...
                <div class="poster_preview">
                    ...
                    if (($tdata['view_type'] == 'movies_library' || $tdata['view_type'] == 'shows_library') &&
                            !empty($cfg['localplayer']) && !empty($prefs->getPrefsItem('view_mode')) &&
                            (!isset($tdata['total_unseen_items']) || (isset($tdata['total_unseen_items']) && $tdata['total_unseen_items'] > 0) )
                    ) {
                        ?>
                    ...
                    <?php } ?>
                    <?php if (($tdata['view_type'] == 'movies_collection')) { ?>
                        <a href="?page=view_group&id=<?= $tdata['id'] ?>&group_type=<?= $tdata['group_type'] ?>&media_type=<?= $tdata['media_type'] ?> ">
                        <?php } else { ?>
                        ...
                        <?php
                        if (!empty($tdata['guessed_poster']) && $tdata['guessed_poster'] != -1) {
                            ?>
